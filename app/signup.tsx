...
export default function SignupScreen() {
    ...
    const handleSignup = () => {
        // Mimic signup success and navigate to tabs
        router.replace('/(tabs)');
    };
            ...
            <KeyboardAvoidingView
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.content}>
                        ...
                        <Text style={styles.subtitle}>Join Chatly and unlock AI power.</Text>

                        <View style={styles.form}>
                            <View style={styles.inputContainer}>
                                <IconSymbol name="person.fill" size={20} color="rgba(255, 255, 255, 0.4)" style={styles.inputIcon} />
                                <TextInput
                                    style={styles.input}
